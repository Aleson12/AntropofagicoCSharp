    ...
    public partial class apserv
    {
        ...
        *************************************************************************/
            ...
            alglib.xparams _params)
        {
            ...
            pool.n = n;
            threadunsafeset(ref pool.temporariescount, 0, _params);
            if( n==0 )
            {
                return;
            }
        ...
        *************************************************************************/
            ...
            alglib.xparams _params)
        {
            ...
            if( threadunsafeget(ref pool.temporariescount, _params)>maxtemporariesinnpool )
            {
                threadunsafeset(ref pool.temporariescount, 0, _params);
        ...
        *************************************************************************/
            ...
            alglib.xparams _params)
        {
            ...
            if( threadunsafeget(ref pool.temporariescount, _params)<0 )
            {
                threadunsafeset(ref pool.temporariescount, 0, _params);
            }
        }
