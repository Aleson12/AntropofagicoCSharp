...
End Class
    ...
    Public Sub minqpsetalgobleic(ByRef state As minqpstate, ByVal epsg As Double, ByVal epsf As Double, ByVal epsx As Double, ByVal maxits As Integer)
        Try
    ...
    Public Sub minnlcsetalgoslp(ByRef state As minnlcstate)
        Try
